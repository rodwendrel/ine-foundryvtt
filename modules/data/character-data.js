export class InECharacterData extends foundry.abstract.DataModel {
  static defineSchema() {
    ...
    return {
      ...
      details: new fields.SchemaField({
        ocupation: new fields.StringField({ initial:"", label: "Ocupação" }),
        origin: new fields.StringField({ initial:"", label: "Origem" }),
      }),
      ...
      defesa: new fields.SchemaField({ value: new fields.NumberField({ initial: 10, integer: true }), total: new fields.NumberField({ integer: true, initial: 10 }) }), // <-- CORRIGIDO
  ...
  prepareBaseData() {
    // Loop de cálculo único e limpo.
    console.log("Preparando dados do personagem...");
